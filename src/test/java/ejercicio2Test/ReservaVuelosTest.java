...
import ejercicio2.ReservaVuelos;
...
public class ReservaVuelosTest {
    ReservaVuelosHelper reservaVuelosHelperMock = Mockito.mock(ReservaVuelosHelper.class);
    ...
    public void verifyReservaDeVuelosConPasajesDispo(){
        ...
        Mockito.when(reservaVuelosHelperMock.existenPasajes("La Paz", 2)).thenReturn(true);
        Mockito.when(reservaVuelosHelperMock.getDay(29, 5, 2023)).thenReturn("Lunes");
        ...
        String actualResult = reservaVuelos.reservaVuelo("La Paz", 2, 29, 5, 2023);
